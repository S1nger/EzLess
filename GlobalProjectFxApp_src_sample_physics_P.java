...
public class P {
    private static double U_1,R_1,SUM;
    private static double i,r,sum;
    @FXML
    private TextField I,answer,R,answer1,U1,R1;
    @FXML
    ...
    public void initialize() {
        ...
        equals.setOnAction(event -> {
            try {
                ...
                sum = (i * i) * r;
                answer.setText((String.valueOf(nf.format(sum)))+ " Вт");
        ...
        equals1.setOnAction(event -> {
            try {
                ...
                SUM = (U_1 * U_1) / R_1  ;
                answer1.setText((String.valueOf(nf.format(SUM)))+ " Вт");
