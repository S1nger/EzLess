        ...
        public void initialize() {
            ...
            action1.setOnAction(event1 -> {
                splitButton.setOnAction(event -> {
                    try{
                        ...
                        sum_One = one_TF / 10;
                        answerTF.setText((String.valueOf(nf.format(sum_One)))+ " СМ");
                    } catch (Exception e) {
            ...
            action2.setOnAction(event1 -> {
                splitButton.setOnAction(event -> {
                    try{
                        ...
                        sum_Two = two_TF * 100;
                        answerTF.setText((String.valueOf(nf.format(sum_Two)))+ " СМ");
                    } catch (Exception e) {
                        showAlertWithHeaderText();
                    }
                });
            ...
            action3.setOnAction(event1 -> {
                splitButton.setOnAction(event -> {
                    try{
                        ...
                        sum_Three = three_TF * 1000;
                        answerTF.setText((String.valueOf(nf.format(sum_Three)))+ " СМ");
                    } catch (Exception e) {
                        showAlertWithHeaderText();
                    }
                });
            ...
            equals.setOnAction(event -> {
                try {
                    ...
                    S = Double.parseDouble(s.getText());
                    SUM = (C * M) / S;
